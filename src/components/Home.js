      ...
      >
        <div className='flex flex-col justify-center h-full'>
          ...
          <p className='text-gray-500 py-4 max-w-md'>
            I have 1 year of internship experience where i was building Tata pay
            UPI feature. Currently i am looking for some opportunities. I love
            working on web and android and i use technologies like React,
            Tailwind, Flutter.
          </p>
